  ...
  return (
    <div className="w-1/4 flex justify-center flex-col">
      ...
      <div>
        ...
        <ul className="p-8 py-3 hover:bg-gray-50 hover:text-sky-500">Toners</ul>
        <ul className="p-8 py-3 hover:bg-gray-50 hover:text-sky-500">
          Exfoliators
        </ul>
        <ul className="p-8 py-3 hover:bg-gray-50 hover:text-sky-500">Creams</ul>
        <ul className="p-8 py-3 hover:bg-gray-50 hover:text-sky-500">Serums</ul>
        <ul className="p-8 py-3 hover:bg-gray-50 hover:text-sky-500">
          Body Care
        </ul>
        <ul className="p-8 py-3 hover:bg-gray-50 hover:text-sky-500">Masks</ul>
        <ul className="p-8 py-3 hover:bg-gray-50 hover:text-sky-500">
          Sunscreens
        </ul>
      </div>
